...
import org.usfirst.frc.team3539.robot.profiles.RightScaleReverseTurn;
...
public class AutonRightScaleRight extends CommandGroup
{
	...
	public AutonRightScaleRight()
	{
		...
		addSequential(new AutonMotionProfileEx(RightScaleReverseTurn.PointsR, RightScaleReverseTurn.PointsL, RightScaleReverseTurn.kNumPoints));
	}
}
